...
typedef NS_ENUM(NSUInteger, PlaceholderTextViewStyle) {
    PlaceholderTextViewStylePlain,
    PlaceholderTextViewStyleBordered,
};
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer {
    ...
    if (self) {
        [self configureTextViewWithStyle:PlaceholderTextViewStyleBordered];
    }
    return self;
}
...
- (void)awakeFromNib {
    [super awakeFromNib];
    [self configureTextViewWithStyle:PlaceholderTextViewStylePlain];
}

- (void)configureTextViewWithStyle:(PlaceholderTextViewStyle)textViewStyle {
    
    [self setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    if (textViewStyle == PlaceholderTextViewStyleBordered) {
