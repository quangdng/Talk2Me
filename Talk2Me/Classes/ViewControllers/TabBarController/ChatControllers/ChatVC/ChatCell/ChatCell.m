...
@property (strong, nonatomic) ImageView *userImageView;
@property (strong, nonatomic) ImageView *balloonImageView;
...
#define DELIVERY_STATUS_ACTIVATED 1


- (void)createContainerSubviews {
    
    self.showUserImage = YES;
    
    self.messageContainer = [[UIView alloc] init];
    self.containerView = [[UIView alloc] init];
    self.balloonImageView = [[ImageView alloc] init];
    self.userImageView = [[ImageView alloc] init];
    ...
    self.userImageView.imageViewType = ImageViewTypeCircle;
    self.balloonImageView.imageViewType = ImageViewTypeNone;
...
- (void)setMessage:(ChatMessage *)message {
    ...
    ChatMessageContentAlign align = self.message.align;
    ChatMessageLayout layout = self.message.layout;
