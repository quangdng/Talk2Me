...
- (void)start {
    ...
    [[ChatReceiver instance] chatContactListDidChangeWithTarget:self block:^(QBContactList *contactList) {
    ...
    [[ChatReceiver instance] chatDidReceiveContactAddRequestWithTarget:self block:^(NSUInteger userID) {
        ...
        if (user != nil) {
            [[ChatReceiver instance] contactRequestUsersListChanged];
            return;
        }
...
- (void)addUsers:(NSArray *)users {
    ...
    [[ChatReceiver instance] postUsersHistoryUpdated];
}
...
- (NSObject<Cancelable> *)retrieveUsersWithFacebookIDs:(NSArray *)facebookIDs completion:(QBUUserPagedResultBlock)completion {
    return [QBUsers usersWithFacebookIDs:facebookIDs delegate:[TMEchoObject instance] context:[TMEchoObject makeBlockForEchoObject:completion]];
}
...
- (NSObject<Cancelable> *)retrieveUserWithID:(NSUInteger)userID completion:(QBUUserResultBlock)completion {
    ...
    return [QBUsers userWithID:userID delegate:[TMEchoObject instance] context:[TMEchoObject makeBlockForEchoObject:resultBlock]];
}
...
- (NSObject<Cancelable> *)resetUserPasswordWithEmail:(NSString *)email completion:(TMResultBlock)completion {
    ...
    return [QBUsers resetUserPasswordWithEmail:email delegate:[TMEchoObject instance] context:[TMEchoObject makeBlockForEchoObject:completion]];
}

- (NSObject<Cancelable> *)updateUser:(QBUUser *)user withCompletion:(QBUUserResultBlock)completion {
    
    return [QBUsers updateUser:user delegate:[TMEchoObject instance] context:[TMEchoObject makeBlockForEchoObject:completion]];
}
