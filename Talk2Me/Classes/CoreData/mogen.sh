...
#  mogen.sh
#
COREDATA_DIR="${PROJECT_DIR}/Talk2Me/Classes/CoreData/"
HUMAN_DIR="${PROJECT_DIR}/Talk2Me/Classes/CoreData/Entries"
MACHINE_DIR="${PROJECT_DIR}/Talk2Me/Classes/CoreData/EntriesMachine"
INCLUDE_H="${PROJECT_DIR}/Talk2Me/Classes/CoreData/ModelIncludes.h"
